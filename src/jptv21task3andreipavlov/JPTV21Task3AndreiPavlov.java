 ...
 */
package jptv21task3andreipavlov;
 ...
 * @author pupil
 */
public class JPTV21Task3AndreiPavlov {
    ...
    public static void main(String[] args) {
        ...
        String[] month = {"Январья","Февралья","Марта","Апрелья","Мая","Июнья","Июлья","Августа","Сентябрья","Октябрья","Ноябрья","Декабрья"};
        String id = scan.next();
